...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI01_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC02_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC02_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC03_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC03_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC06_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AC06_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AU01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AU01_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/BK01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/BK01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI02_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI02_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI03_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI03_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI04_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CI04_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AD01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AD01_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/TD01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/TD01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CM01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CM01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/GS01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/GS01_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CS01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CS01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AQ01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/AQ01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/SH01_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/SH01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/SH02_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/SH02_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/SH03_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/SH03_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD01_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD01_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD02_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD02_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD03_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD03_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD04_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD04_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD05_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD05_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD06_W_20190602.txt"
  /ENCODING='UTF8'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD06_W.sav'
  /COMPRESSED.

PRESERVE.
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD07_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/CD07_W.sav'
  /COMPRESSED.
...
SET DECIMAL DOT.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/MR01_W_20190602.txt"
  /ENCODING='Locale'
  /DELCASE=LINE
  /DELIMITERS="|"
  /ARRANGEMENT=DELIMITED
...
RESTORE. 
 ...
 FORMATS UPLOAD (F8.0). 
 EXECUTE.
SAVE OUTFILE='/Volumes/Promise RAID/Creditsafe 2019v3/UKLTD_W_20190602/MR01_W.sav'
  /COMPRESSED.
